...
(function( $ ) {
    ...
    var Datepicker = function(element, options) {
        ...
        this.naushabaput = this.component && this.element.find('input').length;
    ...
    Datepicker.prototype = {
        ...
        _buildEvents: function(){
            ...
            else if (this.component && this.naushabaput){ // component: input + button
                this._events = [
        ...
        hide: function(e){
            ...
            if (
                ...
                (
                    ...
                    this.naushabaput && this.element.find('input').val()
                )
            )
                this.setValue();
            this._trigger('hide');
